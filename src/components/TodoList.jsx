                    ...
                    <div>
                        <div className="flex items-center space-x-3">
                            <input
                                type="text"
                                id="first_name"
                                className="bg-gray-50 border w-96 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                                placeholder="John"
                                required
                                value={todoInput}
                ...
                <div className="flex flex-col space-y-4 items-center">
                    {todoItems.map((item) => {
                        return (
                            ...
                            <div className="flex items-center space-x-3">
                                <div
                                    className={`p-4  text-sm font-semibold text-blue-800 rounded-lg ${
                                        item.done
                                            ? "bg-yellow-400"
                                            : "bg-blue-200"
                                    }  w-96`}
                                ...
                                <button
                                    type="button"
                                    className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-3 text-center  w-24"
                                ...
                                <button
                                    type="button"
                                    className="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 shadow-lg shadow-red-500/50 dark:shadow-lg dark:shadow-red-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2  w-24"
